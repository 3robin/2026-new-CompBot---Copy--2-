...
public class HorizontalTransfer extends Command {
  /** Creates a new Intake. */

  HorizontalTransferSubsystem HTSubsystem;

  public HorizontalTransfer(HorizontalTransferSubsystem HorizontalSystem) {
    addRequirements(HorizontalSystem);
    this.HTSubsystem = HorizontalSystem;
  }

  public HorizontalTransfer(Command run) {
...
// Called when the command is initially scheduled. Set the rollers to the
 // appropriate values for intaking
  ...
  //   HTSubsystem
  //       .setHorizontalTransfer(
  //           SmartDashboard.getNumber("horizontal transfer value", HORIZONTAL_TRANSFER_VOLTAGE));
